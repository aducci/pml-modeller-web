...
// ─── Section header ─────────────────────────────────────────────────────────
export const Section = ({ title, children }) => (_jsxs("div", { style: { marginBottom: 24 }, children: [_jsx("div", { style: { fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#9CA3AF', padding: '4px 0 8px', borderBottom: '2px solid #E5E7EB', marginBottom: 4 }, children: title }), children] }));
...
export const ColorInput = ({ value, onChange }) => (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 6 }, children: [_jsx("div", { style: { width: 20, height: 20, borderRadius: 4, background: value, border: '1px solid #D1D5DB', flexShrink: 0, cursor: 'pointer', position: 'relative', overflow: 'hidden' }, children: _jsx("input", { type: "color", value: value, onChange: e => onChange(e.target.value), style: { position: 'absolute', inset: '-4px', width: '200%', height: '200%', opacity: 0, cursor: 'pointer' } }) }), _jsx("input", { type: "text", value: value, onChange: e => { if (/^#[0-9A-Fa-f]{0,6}$/.test(e.target.value))
