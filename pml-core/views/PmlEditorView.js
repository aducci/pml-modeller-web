...
import { FolderOpen, ChevronDown, Save, AlertCircle, AlertTriangle, Info, ChevronUp, Wrench, Star } from 'lucide-react';
...
export const PmlEditorView = forwardRef(({ content, onChange, diagnostics = [] }, ref) => {
