...
export const DEFAULT_PROCESS_THEME = {
    ...
    elementStyles: {
        event: {
            shape: 'circle',
            appearance: { fill: '#E6F1FB', stroke: '#378ADD', label: '#0C447C', secondaryLabel: '#0C447C', labelHalo: '#E6F1FB', strokeWidth: 1 },
        ...
        decision: {
            shape: 'diamond',
            appearance: { fill: '#D3D1C7', stroke: '#5F5E5A', label: '#2C2C2A', secondaryLabel: '#2C2C2A', labelHalo: '#D3D1C7', strokeWidth: 1 },
        ...
        task: {
            shape: 'rounded-rect',
            appearance: { fill: '#F1EFE8', stroke: '#888780', label: '#2C2C2A', secondaryLabel: '#2C2C2A', labelHalo: '#F1EFE8', strokeWidth: 1, cornerRadiusPx: 6 },
            text: { fontSizePx: 10, weight: 500, maxLines: 3, wrap: 'clamp' },
            labelPlacement: 'inside',
            infoPolicy: {
                primaryField: 'label',
        ...
        unknown: {
            shape: 'rounded-rect',
            appearance: { fill: '#F1EFE8', stroke: '#D3D1C7', label: '#888780', secondaryLabel: '#888780', labelHalo: '#F1EFE8', strokeWidth: 1, cornerRadiusPx: 6 },
