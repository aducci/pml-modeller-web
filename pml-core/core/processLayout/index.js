...
export function computeProcessLayout(graph, settingOverrides) {
    ...
    return applyLayoutAutoArrange(graph, settingOverrides, result, computeProcessLayoutCore);
}
...
function runRoutingPhase(input) {
    ...
    recordStage(state, 'post-routing-conflict-resolution');
    resolvePostRoutingConflicts(state);
    return state;
}
// ============================================================================
// PHASE D — ANALYSIS
