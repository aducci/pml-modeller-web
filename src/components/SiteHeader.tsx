...
export function SiteHeader({ brandHref = '/' }: { brandHref?: string }) {
  return (
    <nav className="border-b border-gray-100 bg-white" style={{ paddingBottom: 2 }}>
      <div className="mx-auto max-w-6xl px-6 flex items-center justify-between" style={{ paddingTop: 16, paddingBottom: 16 }}>
